// Image loading helpers shared by the image editors, cam and the raster
// gcode generator (moved out of components/image-filters.jsx so the new
// editor can use them without a circular import).
